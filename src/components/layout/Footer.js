...
const Footer = () => {
    ...
    const handleContactClick = (e) => {
        e.preventDefault();
        // Dispatch event for other components to listen to (e.g. Header to open modal)
        window.dispatchEvent(new Event('openContactModal'));

        // Also try to scroll if contact section exists
                    ...
                    <div className="footer-links">
                        <ParallaxSection speed={0.05} direction="up" className="footer-section">
                            ...
                            <ul className="footer-list">
                                ...
                                <li><a href="/blog" className="footer-link reveal-on-scroll" onClick={handleBlogsClick}>Blog</a></li>
                            </ul>
                        </ParallaxSection>

                        <ParallaxSection speed={0.08} direction="up" className="footer-section">
                            <h4 className="footer-title reveal-on-scroll">Products</h4>
                            <ul className="footer-list">
                                <li><a href="/agentic-ai-consulting" className="footer-link reveal-on-scroll" onClick={(e) => { e.preventDefault(); navigate('/agentic-ai-consulting'); }}>Agentic AI Consulting</a></li>
                                <li><a href="/product-strategy" className="footer-link reveal-on-scroll" onClick={(e) => { e.preventDefault(); navigate('/product-strategy'); }}>Product Strategy & Management</a></li>
                                <li><a href="/product-development" className="footer-link reveal-on-scroll" onClick={(e) => { e.preventDefault(); navigate('/product-development'); }}>Product Development</a></li>
                            </ul>
                        </ParallaxSection>
