...
import { CompanyLogos, Features, AIExpertise, WhyWorkWithUs, Testimonials } from '../components';
          ...
          <div className="container">
            ...
            <div className="services-grid">
                ...
                <div className="service-icon">
                  <div className="icon-circle purple">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                      <path d="M12 2L2 7V10C2 16 6 20.88 12 22C18 20.88 22 16 22 10V7L12 2Z" fill="currentColor" />
                    </svg>
                  </div>
                </div>
                <h3 className="service-title">Agentic AI Consulting</h3>
                <p className="service-description">Strategic guidance to empower your business with autonomous AI agents. We help you identify high-impact use cases and design the architecture for a self-managing enterprise.</p>
                <div className="service-link-wrapper" style={{ marginTop: '20px' }}>
                  <a href="/agentic-ai-consulting" className="text-primary font-weight-bold" style={{ color: 'var(--color-primary)', textDecoration: 'none', fontWeight: 'bold' }}>Learn More →</a>
                </div>
              </div>
              ...
              <div className="service-card">
                ...
                <h3 className="service-title">Product Strategy & Management</h3>
                <p className="service-description">Defining the roadmap to scalable success. We align technology capabilities with market needs, crafting detailed roadmaps and go-to-market strategies.</p>
                <div className="service-link-wrapper" style={{ marginTop: '20px' }}>
                  <a href="/product-strategy" className="text-primary font-weight-bold" style={{ color: 'var(--color-primary)', textDecoration: 'none', fontWeight: 'bold' }}>Learn More →</a>
                </div>
              </div>
              ...
              <div className="service-card">
                ...
                <h3 className="service-title">Product Development Services</h3>
                <p className="service-description">Building scalable, world-class AI products. From MVP to enterprise-scale deployment, our development teams engineer robust and secure AI solutions.</p>
                <div className="service-link-wrapper" style={{ marginTop: '20px' }}>
                  <a href="/product-development" className="text-primary font-weight-bold" style={{ color: 'var(--color-primary)', textDecoration: 'none', fontWeight: 'bold' }}>Learn More →</a>
                </div>
              </div>
            </div>
